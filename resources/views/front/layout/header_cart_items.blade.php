{{-- This file is 'include'-ed in front/layout/header.php. We separated the Mini Cart widget and cut it from
front/layout/header.blade.php to here --}}
...
<div class="mini-cart-wrapper">
    <div class="mini-cart">
        ...
        <div class="mini-action-anchors">
            ...
            <a href="{{ url('checkout') }}" class="checkout-anchor">{{ __('site.checkout') }}</a>
        </div>
    </div>
</div>
<!-- Mini Cart /- -->
...
{{-- Solution of the problem where the X icon of the Mini Cart Widget doesn't work (doesn't close the widget) after
Updating the Cart or Deleting items from it (meaning, AFTER MAKING AJAX CALLS). This happens after using AJAX while
updating or deleting cart items because the Mini Cart Widget page gets loaded again and return-ed via AJAX but return-ed
